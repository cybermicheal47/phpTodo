...
<div class="font-sans text-gray-900 antialiased">
    <div class="bg-gray-50  min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
        <div>
                ...
                <h2 class="font-bold text-3xl">Log <span class="bg-green-300 text-white px-2 rounded-md">IN</span></h2>
...
<!--                        <span class="text-2xl font-semibold">Log In</span>-->
                ...
                <div class="flex items-center justify-end mt-4">
                    <a class="hover:underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="/register">
                        No account? .signup
                    </a>
